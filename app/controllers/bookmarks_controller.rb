class BookmarksController < ApplicationController
  ...
  def index
    ...
    @bookmarks = @q.result(:distinct => true).includes(:dish, :venue, :neighborhood, :user).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def bookmark_params
      params.require(:bookmark).permit(:dish_id, :venue_id, :neighborhood_id, :user_id, :notes)
    end
end
